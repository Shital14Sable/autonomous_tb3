...
class NavigatorApp:
    def __init__(self):
        ...
        self.create_button('Table 1' , -3.514500 , -1.425685)
        self.create_button('Table 2' , -3.425865 , 3.461600)
        self.create_button('Table 3' , 3.428090 , 3.448285)
        self.create_button('Table 4' , 3.480000 , -1.488200)
    ...
    def go_to_pose(self,x,y):
        ...
        counter_return.pose.position.x = 3.480000
        counter_return.pose.position.y = -5.632428
